...
const SocialM = () => {
    return (
        <section>
            <div className='grid lg:grid-cols-5 grid-cols-2 transition-all  container lg:h-[200px] '>
                <div className='lg:p-20 p-16  lg:border-r divv   border-[#aaaaaa6b]  items-center'>
                    <a href="https://web.facebook.com/DarDjajAgadir/" target='_blank'>
                ...
                <div className='lg:p-20 p-16 p-10  lg:border-r divv border-[#aaaaaa6b] '>
                    <a href="https://www.youtube.com/@dardjaj1106" target='_blanck'>
                        <svg className='m-auto' xmlns="http://www.w3.org/2000/svg" width="50" height="50" viewBox="0 0 50 50" fill="none">
